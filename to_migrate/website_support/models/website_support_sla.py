    ...
    def _compute_display_value(self):
        for rec in self:
            if rec.type == "category":
                rec.display_value = rec.category_id.name
            elif rec.type == "subcategory":
                rec.display_value = rec.subcategory_id.name
            elif rec.type == "priority":
                rec.display_value = rec.priority_id.name
