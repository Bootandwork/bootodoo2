        ...
        start: function() {
            ...
            if (!this.editableMode) {
                ...
                ajax.jsonRpc("/theme_crafito/blog_get_dynamic_slider", 'call', {
                    'slider_type': self.$target.attr('data-blog-slider-type') || '',
                }).then(function(data) {
                    if (data) {
                        self.$target.empty();
        ...
        start: function() {
            ...
            if (!this.editableMode) {
                ...
                ajax.jsonRpc("/theme_crafito/category_get_dynamic_slider", 'call', {
                    'slider_id': self.$target.attr('data-cat-slider-id') || '',
                }).then(function(data) {
                    if (data) {
                        self.$target.empty();
                        self.$target.append(data);
        ...
        start: function() {
            ...
            if (!this.editableMode) {
                ...
                ajax.jsonRpc("/theme_crafito/product_get_dynamic_slider", 'call', {
                    'slider_id': self.$target.attr('data-prod-slider-id') || '',
                }).then(function(data) {
                    if (data) {
                        self.$target.empty();
                        self.$target.append(data);
        ...
        start: function() {
            ...
            if (!this.editableMode) {
                ...
                ajax.jsonRpc("/theme_crafito/featured_product_get_dynamic_slider", 'call', {
                    'slider_id': self.$target.attr('data-featured-prod-slider-id') || '',
                }).then(function(data) {
                    if (data) {
                        self.$target.empty();
                        self.$target.append(data);
                ...
                $.get('/biztech_skill_model_data/skill_data', {}).then(function(data) {
                    ...
                    var waypoints = self.$target.find('#skill-counter').waypoint({
                        ...
                        handler: function(direction) {
                            if(self.$target.find('#skill_graph_1').length==1 && i!=2)
                            {
        ...
        start: function() {
            ...
            if (!this.editableMode) {
                ...
                ajax.jsonRpc("/theme_crafito/newsone_get_dynamic_slider", 'call', {
                    'slider_type': self.$target.attr('data-newsone-slider-type') || '',
                }).then(function(data) {
                    if (data) {
                        self.$target.empty();
                        self.$target.append(data);
        ...
        start: function() {
            ...
            if (!this.editableMode) {
                ...
                ajax.jsonRpc("/theme_crafito/newstwo_get_dynamic_slider", 'call', {
                    'slider_type': self.$target.attr('data-newstwo-slider-type') || '',
                }).then(function(data) {
                    if (data) {
                        self.$target.empty();
                        self.$target.append(data);
        ...
        start: function() {
            ...
            if (!this.editableMode) {
                ...
                ajax.jsonRpc("/theme_crafito/theme_new_hardware_blog", 'call', {
                    'slider_type': self.$target.attr('data-hardware-newblog-slider-type') || '',
                }).then(function(data) {
                    if (data) {
                        self.$target.empty();
                        self.$target.append(data);
