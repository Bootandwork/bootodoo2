...
publicWidget.registry.s_d_brand_snippet = RootWidget.extend({
    ...
    _modifyElementsAfterAppend: function () {
        ...
        if (this.mode === 'slider') {
            ...
            this.$('.owl-carousel').owlCarousel({ nav: false, dots: false, autoplay: true, autoplayTimeout: 4000, rtl: _t.database.parameters.direction === 'rtl', responsive: {0: {items: 2}, 576: {items: 4}}});
        }
    },
});
